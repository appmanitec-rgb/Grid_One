...
export const STUDIO_RESOURCES: StudioResource[] = [
  ...
  {
    key: "operationalExpenseRates",
    label: "Tarifa Operacional",
    pluralLabel: "Tarifas Operacionais",
    category: "Financeiro",
    description:
      "Valores padrao de deslocamento, alimentacao, pedagio, hospedagem e estacionamento usados nas propostas.",
    endpoint: "/studio/data/operationalExpenseRates",
    updateEndpoint: (id) => `/studio/data/operationalExpenseRates/${id}`,
    ...
    fields: [
      {
        ...
        sortable: true,
        options: [
          { value: "DISPLACEMENT", label: "Deslocamento" },
          { value: "MEAL", label: "Alimentacao" },
  ...
  {
    key: "commercialGenerators",
    label: "Gerador para Venda",
    pluralLabel: "Geradores para Venda",
    category: "Comercial",
    description:
      "Catalogo exclusivo de geradores Generac novos, com ficha tecnica, precos, estoque e prazo.",
    endpoint: "/studio/data/commercialGenerators",
    ...
    fields: [
      ...
      {
        key: "availableVoltages",
        label: "Tensoes (separadas por virgula)",
        searchable: true,
        editable: true,
      },
      {
        key: "availablePhaseConfigs",
        label: "Ligacoes (separadas por virgula)",
        searchable: true,
        editable: true,
      },
      {
      ...
      },
      {
        ...
        editable: true,
        required: true,
        defaultValue: "SOUND_ATTENUATED",
        options: [
          { value: "OPEN", label: "Aberto" },
          { value: "CANOPIED", label: "Carenado" },
          { value: "SOUND_ATTENUATED", label: "Carenado / Silenciado" },
        ],
      },
      {
        key: "supportsIndoor",
      ...
      },
      {
        ...
        options: [
          ...
          { value: "AVAILABLE_TO_ORDER", label: "Disponivel para pedido" },
      ...
      },
      {
        ...
        label: "Descricao do motor",
        searchable: true,
        editable: true,
        hiddenByDefault: true,
      },
      {
        key: "alternatorDescription",
        label: "Descricao do alternador",
        searchable: true,
        editable: true,
        hiddenByDefault: true,
      },
      {
        ...
        label: "Descricao do controlador",
        searchable: true,
        editable: true,
        hiddenByDefault: true,
      },
      {
        key: "enclosureDescription",
        label: "Descricao da carenagem",
        searchable: true,
        editable: true,
        hiddenByDefault: true,
      },
      {
        key: "standardAccessories",
        label: "Acessorios padrao",
        searchable: true,
        editable: true,
        hiddenByDefault: true,
      },
  ...
  {
    key: "commercialSizingPolicies",
    label: "Regra de Pre-dimensionamento",
    pluralLabel: "Regras de Pre-dimensionamento",
    category: "Comercial",
    description:
      "Margens e limites comerciais versionados para a futura recomendacao assistida.",
    endpoint: "/studio/data/commercialSizingPolicies",
    ...
    fields: [
      ...
      },
      {
        ...
        editable: true,
        required: true,
        defaultValue: "Politica comercial",
      },
      {
        key: "version",
        label: "Versao",
      ...
      {
        key: "defaultPowerFactor",
        label: "Fator de potencia padrao",
        type: "number",
        editable: true,
        defaultValue: 0.8,
      },
      {
        key: "standardMarginPercent",
        label: "Margem padrao %",
        type: "number",
        sortable: true,
        editable: true,
      ...
      {
        key: "airConditioningMarginPercent",
      ...
      {
        key: "idealReserveMinPercent",
        label: "Reserva ideal minima %",
        type: "number",
        editable: true,
        defaultValue: 10,
      },
      {
        key: "idealReserveMaxPercent",
        label: "Reserva ideal maxima %",
        type: "number",
        editable: true,
        defaultValue: 35,
      },
      {
        key: "engineeringReviewAboveKw",
        label: "Validar engenharia acima de kW",
        type: "number",
        editable: true,
      },
      {
        key: "requireEngineeringSpecialLoads",
        label: "Validar cargas especiais",
        type: "boolean",
        editable: true,
        defaultValue: true,
      },
