...
export class TechniciansController {
  ...
  @Get(':id')
  findOne(@Param('id') id: string) { // Removido o +
    return this.techniciansService.findOne(id);
  }

  @Patch(':id')
  update(@Param('id') id: string, @Body() updateTechnicianDto: UpdateTechnicianDto) { // Removido o +
    return this.techniciansService.update(id, updateTechnicianDto);
  }

  @Delete(':id')
  remove(@Param('id') id: string) { // Removido o +
