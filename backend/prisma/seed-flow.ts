...
async function main() {
  ...
  const generator = await prisma.generator.upsert({
    ...
    update: {
      ...
      application: 'Emergencia hospitalar',
      voltage: '380/220 V',
      ratedCurrent: '1139 A',
      powerFactor: 0.8,
      frequencyHz: 60,
      operationMode: 'Stand-by com partidas semanais',
      engineBrand: 'Cummins',
      engineModelName: 'QSK23-G3',
      engineSerialNumber: 'ENG-DEMO-0001',
      enginePower: '810 kWm',
      fuelType: 'Diesel',
      engineCylinders: 12,
      oilRecommendation: '15W40 API CI-4',
      oilCapacityLiters: 82,
      alternatorBrand: 'Stamford',
      alternatorModelName: 'HCI544F',
      alternatorVoltage: '380/220 V',
      alternatorFrequencyHz: 60,
      alternatorInsulationClass: 'H',
      alternatorProtectionDegree: 'IP23',
      hasTransferSwitch: true,
      transferSwitchBrand: 'Schneider',
      transferSwitchModel: 'QTA 1600A',
      transferSwitchRatedCurrent: '1600 A',
      transferSwitchCommandVoltage: '220 Vca',
      transferSwitchType: 'Automatica',
      batteryQuantity: 2,
      batteryVoltage: '12 V',
      batteryCapacityAh: 150,
      batteryChargerModel: 'Carregador automatico 24 Vcc',
      notes: 'Equipamento critico para area assistencial. Validar autonomia e partida em todas as preventivas.',
      clientId: client.id,
      modelId: model.id,
  ...
  const generatorB = await prisma.generator.upsert({
    ...
    update: {
      ...
      application: 'Backup industrial',
      voltage: '440 V',
      ratedCurrent: '590 A',
      powerFactor: 0.8,
      frequencyHz: 60,
      operationMode: 'Stand-by industrial',
      engineBrand: 'MWM',
      engineModelName: 'Industrial 6 cilindros',
      enginePower: '480 kWm',
      fuelType: 'Diesel',
      engineCylinders: 6,
      alternatorBrand: 'WEG',
      alternatorVoltage: '440 V',
      alternatorFrequencyHz: 60,
      hasTransferSwitch: true,
      transferSwitchType: 'Automatica',
      batteryQuantity: 2,
  ...
  const serviceReportB = serviceReportBExisting
    ? await prisma.serviceReport.update({
        ...
        data: {
          ...
          validationExpiresAt: addDays(now, 30),
          validationRevokedAt: addDays(now, -1),
          revokedAt: addDays(now, -1),
          revokedById: adminUser.id,
          revokeReason: 'Documento E2E revogado para validar bloqueio publico.',
